...
**Document ID:** CQO-CAPA-LOG  
**Owner:** Chief Quality Officer (Veritas)  
**Status:** ACTIVE  

This log serves as the ISO 9001:2026 record for tracking and resolving all **Yellow Light** warnings, cost deviations, and corrective actions taken by the Staff.
